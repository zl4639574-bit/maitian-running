...
TABLES = [
    ('01_队员资料收集表.xlsx', '队员资料',
     ['姓名', '性别', '学院', '专业', '年级', '身份', '800米', '1500米', '3000米', '5000米', '10000米', '半马', '全马'],
     [10, 6, 16, 16, 8, 8, 9, 9, 9, 9, 10, 9, 9],
     '身份填 正式 / 预备 / 普通（正式、预备会显示在公开名册里，普通=队里的人但不进公开名册）；'
...
【这三个文件分别用在哪】
  ...
  01_队员资料收集表.xlsx
      ...
      表头必须是：姓名 性别 学院 专业 年级 身份 800米 1500米 3000米 5000米 10000米 半马 全马
